# 12:12 · 22.08.2026 · ПАУЗА ИЛИ КОНЕЦ

Текст поста не переписывать. Только кадр.
...
why: пост про «давай паузу», две недели тишины и лайк — телефон и пустая половина постели, медальон лежит на льне как предмет.
kie-ready: yes

## Выдача

- `cover-raw.png` — сырой кадр 1K с Kie, без подписи
- `cover.png` — тот же кадр + подпись кодом
