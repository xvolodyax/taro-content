...
Уже готово: есть brief.md: кластер «мириться после ссоры», wordstat PARTIAL, кадр = утро / чат на вчерашней реплике / ссора не закрыта. Слово Сцена не писать. Слово ловушка нельзя. Не писать площадки и хук. publish SKIP.
