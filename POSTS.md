...
- Финал: пульс **«Похоже? / Не то»**. Telegram + ВК.
...
Instagram и Макс нет. YouTube: пульс в подписи, если второй опрос больно.
...
В эфире нет слова «Сцена». Позиция 3 — она. Пульс «Похоже? / Не то».
...
- **gate:** на 21:21 только длина ≤1024, «Сцена», пустая вода про «примерить»,
  пульс, позиция 3 = она. Предложения не трогает.
