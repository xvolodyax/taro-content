...
Art кладёт на клетку cover холста 2K 2×2 **готовую** строку из `clickbait.txt` и **жирную красную рамку**. Свою не придумывает. Врезки без лица Вики. Не четыре 1K. Cover в тело не дублировать.
