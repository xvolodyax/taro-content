...
Art на единственный кадр 16:9 кладёт **готовую** строку из `clickbait.txt` и **жирную красную рамку**. Свою не придумывает. Не шесть картинок. В тело ту же картинку не ставить.
Обложка 16:9, `Виктория.png` (2 191 823 байт), глаза зелёные с лёгким карим оттенком, микрофон в руке у рта.
