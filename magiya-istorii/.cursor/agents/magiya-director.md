...
Art — после Clickbait: холст 2K 2×2 (cover + inline-01…03), overlay из clickbait.txt на клетке cover, прозу не пишет
```
...
- **Не «ещё раз нарисуй».** Один холст 2K. Не четыре 1K. Не сетка 2×3. i2i/Kie не крутить. Живые пакеты не перерисовывать
