...
Один короткий ударный заголовок **на клетку cover холста 2×2** (кликбейт в ленту) и требование **жирной красной окантовки** этой клетки. Не четыре одинаковых рамки.
