...
Art: обложка 16:9 (1K), глянец 2020-х. Вика держит DJI Mic Mini в руке у рта, глаза строго зеленые с карим оттенком.
Жирная красная рамка по периметру + clickbait.txt (display-шрифт).
Свет и локацию Art берет из сюжета, в базовое ядро промпта «ночь» не зашивать.
Одна генерация обложки. Картинка не валит текст. Лицо Холл не рисует. Не публиковать.
