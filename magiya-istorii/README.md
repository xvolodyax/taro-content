...
Art: один холст 2K 16:9 2×2 (не 1:1), толстые белые швы, затем срез cover + inline-01…03 — все клетки 16:9.
Клетка cover: CHARACTER LOCK как у статей (Виктория.png, 33 youthful, honey/wheat, green/hazel, photoreal) → потом микрофон DJI в руке у рта, жирная красная рамка + clickbait.txt на пикселях.
Врезки без лица Вики. Не четыре 1K createTask. Не квадратный мастер. Не одна 16:9 без врезок (новые пакеты). Cover в тело не дублировать.
...
Art после Clickbait (холст 2K 16:9 2×2, overlay на клетке cover)
...
| 7 | `magiya-art` | `art-brief.md`, холст 2K 16:9 → `cover.png` + `inline-01`…`03` |
