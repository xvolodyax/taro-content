...
- Запрещено переписывать площадки «чтобы прошло». На alena-0700 прозу не переписывать вообще
...
Только проверка. Прозу не переписывать. FAIL с причиной, не тихий рерайт. Sol не возвращать.
