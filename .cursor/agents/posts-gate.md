...
**21:21:** copywriter + gate. Researcher опционален (4 вопроса). Meaning нет.
...
- 12:12 с 16.09: есть «Спроси у карт:» и 2–3 • вопроса к картам; нет «Если выбираешь ход на сегодня» и меню хода; нет мутного эссе; IG слово + «ссылки в шапке»; YT шапка; TG ≤ 1024
- 12:12 до 16.09: живые пакеты не требовать переписать
...
- 21:21 ТОЛЬКО: TG ≤ 1024; нет «Сцена»; нет пустой воды про «примерить»;
  с 15.09: 4 карты, «Вытянула четыре карты», 4 заголовка;
  позиция 3 про неё; позиция 4 = ход сейчас, не «отпусти»;
  пульс точно `Похоже? ❤️/ Не то ⚡`
- 21:21 до 15.09: живые 3-карточные пакеты не требовать переписать
