...
- **Reels:** 12 reel packs (01 to 12) exist. Each contains `script-draft.md` (Gemini's draft), `script.md` (Смыслы final), `smysly.md` (scores), `storyboard.md`, `caption.md`, `code-word.txt`, and `montage.md`.
