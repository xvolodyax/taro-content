...
| Пишет текст | Модель |
| --- | --- |
| Gemini (`script-draft.md`) | `gemini-3.8-flash-high` |
| Смыслы (`script.md`, `smysly.md`) | `gemini-3.8-flash-high` |
| Funnel (`caption.md`) | `gemini-3.8-flash-high` |
| Storyboard (`storyboard.md`) | `gemini-3.8-flash-high` |
| Монтаж (`montage.md`, `montage-ai.json`) | `gemini-3.8-flash-high` |
| Вопросы (`questions.md`) | `gemini-3.8-flash-high` |
