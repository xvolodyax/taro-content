...
| 4 | Gemini | `5-gemini.md` | `gemini-3.7-flash-high` | `script-draft.md` |
| 5 | Смыслы | `smysly.md` | `gemini-3.7-flash-high` | `script.md`, `smysly.md` |
| 6 | Funnel | `6-funnel.md` | `gemini-3.7-flash-high` | `caption.md`, `code-word.txt` |
| 7 | Storyboard | `7-storyboard.md` | `gemini-3.7-flash-high` | `storyboard.md` |
| 8 | Монтаж | `9-montage.md` | `gemini-3.7-flash-high` | `montage.md`, `montage-ai.json` |
| 9 | Вопросы | `10-questions.md` | `gemini-3.7-flash-high` | `questions.md` |
| 10 | Gate | `8-gate.md` | inherit | PASS/FAIL |

Текстовые Task: явно `model: gemini-3.7-flash-high`.
