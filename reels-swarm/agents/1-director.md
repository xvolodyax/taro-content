...
Текст, который видит зритель или уходит в монтаж как текст, пишет **только Gemini 3.7**.
...
| Gemini | `5-gemini.md` | `gemini-3.7-flash-high` | `script-draft.md` |
| Смыслы | `smysly.md` | `gemini-3.7-flash-high` | `script.md`, `smysly.md` |
| Funnel | `6-funnel.md` | `gemini-3.7-flash-high` | `caption.md`, `code-word.txt` |
| Storyboard | `7-storyboard.md` | `gemini-3.7-flash-high` | `storyboard.md` |
| Монтаж | `9-montage.md` | `gemini-3.7-flash-high` | `montage.md`, `montage-ai.json` |
| Вопросы | `10-questions.md` | `gemini-3.7-flash-high` | `questions.md` |
